...
module.exports = {
    ...
    .setName('drip_avatar')
    .setDescription('drip somone avatar.')
    ...
    async execute(interaction, client) {
        ...
        const url = `https://vacefron.nl/api/drip?user=${user.user.avatarURL({dynamic: true, size: 256, extension: 'png'})}`
        const embed = new EmbedBuilder()
        .setTitle(`${user.user.username}'s drips`)
        .setImage(url)
        .setColor(0x18e1ee)
